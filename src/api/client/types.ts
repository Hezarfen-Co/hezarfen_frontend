...
export type PodcastJobArtifacts = {
 ...
 /**
  * The episode's narration as plain text, chapters joined by blank lines —
  * no timings. `null` when the service did not report one (every job that
  * finished before the backend stored it).
  */
