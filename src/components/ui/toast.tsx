  ...
  return (
    <Portal>
      <div class="pointer-events-none fixed inset-x-3 top-4 z-80 flex flex-col items-end gap-2 sm:inset-x-auto sm:right-5 sm:w-96">
        <For each={toasts()}>
          {(toast) => (
            <div class="pointer-events-auto flex w-full items-center gap-3 rounded-xl border border-black/8 bg-card/95 px-3.5 py-2.5 text-card-foreground shadow-apple backdrop-blur-xl dark:border-white/12">
