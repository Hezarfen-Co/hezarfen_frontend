...
export function DataTableViewMenu(props: DataTableViewMenuProps) {
  ...
  return (
    <DropdownMenu placement="bottom-end" gutter={6}>
      <DropdownMenuTrigger class="ml-auto inline-flex h-9 items-center justify-center gap-2 whitespace-nowrap rounded-lg border border-border/70 bg-muted/40 px-3.5 text-sm font-medium transition-all hover:bg-muted active:scale-[0.98] focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring">
        {t("common.columns")}
