...
function NavLink(props: {
  ...
  return (
    <Link
      ...
      class={cn(
        "group relative flex h-10 w-full items-center rounded-xl text-sm font-medium outline-none",
    ...
    >
      ...
      <span
        class={cn(
          ...
          active() ? "bg-primary text-primary-foreground shadow-sm" : "text-muted-foreground group-hover:bg-background/60 group-hover:text-foreground",
        )}
      >
