...
const copy = {
  en: {
    ...
    recents: "Recents",
    collapseHistory: "Hide chat history",
    expandHistory: "Show chat history",
    loadMore: "Show more",
    ...
    thinking2: "Reading the sources…",
    thinking3: "Preparing the answer…",
    copy: "Copy",
    copied: "Copied",
    retry: "Ask again",
  ...
  tr: {
    ...
    collapseHistory: "Sohbet geçmişini gizle",
    expandHistory: "Sohbet geçmişini göster",
    loadMore: "Daha fazla göster",
    greetingMorning: "Günaydın",
    greetingAfternoon: "İyi günler",
    greetingEvening: "İyi akşamlar",
    openHistory: "Sohbet geçmişini aç",
    ...
    thinking2: "Kaynaklar taranıyor…",
    thinking3: "Yanıt hazırlanıyor…",
    copy: "Kopyala",
    copied: "Kopyalandı",
    retry: "Tekrar sor",
    scrollToLatest: "En son",
    newMessages: "Yeni mesaj",
    groupToday: "Bugün",
    groupYesterday: "Dün",
    groupThisWeek: "Bu hafta",
    groupEarlier: "Daha önce",
    sources: "Kaynaklar",
    source: "Kaynak",
    subject: "Ders",
    pages: "Sayfalar",
