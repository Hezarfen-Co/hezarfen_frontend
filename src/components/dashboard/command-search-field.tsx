...
export function CommandSearchField(props: { class?: string }) {
  ...
  return (
    ...
    >
      ...
      <kbd class="hidden shrink-0 rounded-md border border-border/80 bg-background/80 px-1.5 py-0.5 font-mono text-[11px] font-semibold text-muted-foreground sm:inline-block">
        Ctrl/Cmd K
      </kbd>
    </button>
  );
