...
export const en: Dict = {
  ...
  "classBlueprints.noMatch": "Blueprint saved, but no class is at {grade}, so nothing was attached.",
  "classBlueprints.delete": "Delete blueprint",
  "classBlueprints.deleteConfirm":
    "Delete the {grade} blueprint? The courses it attached are detached from every class at this grade. Hand-attached courses stay.",
  "classBlueprints.deleted": "Blueprint deleted.",
  "classBlueprints.status": "Check sync",
  "classBlueprints.statusTitle": "Sync status for {grade}",
  ...
  "classBlueprints.noBlueprintForGrade": "There is no blueprint for {grade} yet.",
  ...
  "profile.statFocusMinutes": "Minutes focused",
  ...
  "notes.filesUploadOnSave": "Your staged files will upload when you save the note.",
  "notes.removeFile": "Remove file",
  "notes.fileUploadFailed": "Note saved, but these files could not be uploaded: {files}",
  "notes.open": "Open",
  ...
  "notifications.clearAllConfirmTitle": "Clear all notifications?",
  "notifications.clearAllConfirmSummary": "The {count} notifications in the list will be removed.",
  ...
  "errors.pageLoad.title": "This page could not load",
  "errors.pageLoad.retry": "Try again",
  "errors.pageLoad.retryIn": "Try again ({seconds}s)",
  "errors.pageLoad.details": "Technical details",
  "errors.pageLoad.status": "HTTP status",
  "errors.pageLoad.kind": "Cause",
  "errors.pageLoad.code": "Error code",
  "errors.pageLoad.module": "Module",
  "errors.pageLoad.retryAfter": "Retry after",
  "errors.pageLoad.seconds": "{seconds}s",
  "errors.pageLoad.page": "Page",
  "errors.pageLoad.message": "Raw message",
  "errors.pageLoad.kind.rateLimited": "Too many requests (rate limited)",
  "errors.pageLoad.kind.moduleOff": "Module switched off for the school",
  "errors.pageLoad.kind.unauthorized": "Session is not valid",
  "errors.pageLoad.kind.forbidden": "No permission",
  "errors.pageLoad.kind.timeout": "Request timed out",
  "errors.pageLoad.kind.unavailable": "Service temporarily unavailable",
  "errors.pageLoad.kind.server": "Server error",
  "errors.pageLoad.kind.request": "Request rejected",
  "errors.pageLoad.kind.offline": "No internet connection",
  "errors.pageLoad.kind.network": "Could not reach the server",
  "errors.pageLoad.kind.render": "Page error in the app",
  "errors.recordNotFound.title": "Record not found",
  "errors.recordNotFound.description": "This record may have been deleted, or the link is wrong.",
  "errors.recordNotFound.backToList": "Back to the list",
  "errors.recordNotFound.backHome": "Back to home",
  ...
  "fab.hide": "Hide",
  "fab.restore": "Show quick actions",
  ...
  "roster.class": "Class",
  "roster.enrolledVia": "Enrolled via",
  "roster.term": "Term",
  ...
  "roster.teachersSubtitle": "Every teacher in the school, the sections they teach and the classes they lead.",
  ...
  "roster.taughtSections": "Sections taught",
  "roster.homeroomOf": "Homeroom",
  ...
  "common.showingOf": "Showing {shown} of {total} — scroll for more",
  "common.rowCount": "Total: {total}",
  ...
  "common.gotIt": "Got it",
  "confirm.review": "Check the summary below before you confirm.",
  "confirm.summary": "Summary",
  "confirm.irreversible": "This can't be undone.",
  ...
  "insights.noAnalysis": "No analysis",
  ...
  "aiStudio.resizeRail": "Audio workshop panel width",
  "aiStudio.resizeHint": "Drag to resize · double-click to reset",
  "aiStudio.backToLibrary": "Back to library",
  ...
  "sidePanel.discard": "Discard changes",
  "sidePanel.keepEditing": "Keep editing",
  "sidePanel.expand": "Expand panel",
  "sidePanel.collapse": "Restore panel width",
  "sidePanel.resize": "Resize panel",
  ...
  "auth.school": "School",
  "auth.noSchoolOpen": "No school is open for registration.",
  ...
  "auth.showConfirmPassword": "Show password confirmation",
  "auth.hideConfirmPassword": "Hide password confirmation",
  "auth.passwordMinHint": "At least {min} characters.",
  "auth.passwordTooShort": "The password needs at least {min} characters.",
  ...
  "command.action.importNote": "Note import assistant",
  ...
  "command.action.askCelebi": "Chat with Çelebi",
  ...
  "command.group.courses": "Courses",
  "command.group.exams": "Exams",
  "command.group.homework": "Homework",
  "command.group.events": "Events",
  "command.recordsLoading": "Loading courses, exams and other records…",
  "command.resultCount": "{count} results",
  "command.homeworkDue": "Due {date}",
  "search.hint.commandRecords": "You can also search by name: {kinds}.",
  ...
  "dashboard.col.section": "Course / Section",
  ...
  "podcast.stage.queued": "Waiting in queue",
  "podcast.stage.ocr": "Reading the document",
  "podcast.stage.plan": "Planning the episode",
  "podcast.stage.kaynak": "Reading the source",
  "podcast.stage.metin": "Extracting the text",
  "podcast.stage.ingest": "Taking in the source",
  "podcast.stage.script": "Writing the script",
  "podcast.stage.scriptler": "Writing the script",
  "podcast.stage.quiz": "Adding questions",
  "podcast.stage.tts": "Narrating",
  "podcast.stage.ses": "Narrating",
  "podcast.stage.mux": "Mixing",
  "podcast.stage.done": "Ready",
  ...
  "podcast.history.title": "Episodes",
  "podcast.history.episode": "Episode",
  ...
  "audio.playerFor": "Player: {title}",
  "audio.play": "Play",
  "audio.pause": "Pause",
  "audio.seek": "Position",
  "audio.position": "{current} of {total}",
  "audio.back": "Back {secs} seconds",
  "audio.forward": "Forward {secs} seconds",
  "audio.speed": "Playback speed: {rate}",
  "audio.mute": "Mute",
  "audio.unmute": "Unmute",
  "audio.volume": "Volume",
  "audio.loadingPosition": "Loading this part…",
  "audio.loadFailed": "The audio could not be loaded.",
  "podcast.transcript.title": "Transcript",
  ...
  "insights.recomputeQueuedUnnamed": "The analysis was queued.",
  ...
  "draw.fullscreen": "Full screen",
  "draw.exitFullscreen": "Exit full screen",
  "draw.color": "Colour",
  ...
  "draw.bgLines": "Lines",
  "draw.bgGrid": "Grid",
  "draw.colorName.black": "Black",
  "draw.colorName.red": "Red",
  "draw.colorName.blue": "Blue",
  "draw.colorName.green": "Green",
  "draw.colorName.yellow": "Yellow",
  "whiteboard.canvasHintPickPen": "Pick a tool above to draw — everyone on the board sees it live.",
  "draw.tools": "Tools",
  ...
  "draw.arrow": "Arrow",
  "draw.line": "Line",
  "draw.colorName.orange": "Orange",
  "draw.style": "Style",
  "draw.widthThin": "Thin",
  "draw.widthBold": "Bold",
  "draw.widthExtraBold": "Extra bold",
  "draw.strokeStyle": "Stroke style",
  "draw.styleSolid": "Solid",
  "draw.styleDashed": "Dashed",
  "draw.styleDotted": "Dotted",
  "draw.sloppiness": "Sloppiness",
  "draw.slopArchitect": "Architect",
  "draw.slopArtist": "Artist",
  "draw.slopCartoonist": "Cartoonist",
  "draw.showGrid": "Show grid",
  "whiteboard.panHint": "To move the canvas, scroll or hold Space while dragging; Ctrl + scroll zooms.",
  "whiteboard.shapeHint": "Hold Shift for a square, a circle or a 45° line.",
  "whiteboard.eraserHint": "Sweep over the strokes to erase; they go when you let go.",
  "whiteboard.menu": "Board menu",
  "whiteboard.lockedBanner": "Board locked — drawing is paused.",
  "whiteboard.closedBanner": "Board closed: read-only for good, it can't be reopened.",
  "whiteboard.readOnlyBanner": "You're not on this board — you can only watch.",
  "whiteboard.you": "You",
  "exams.publishOnCreateWarning": "Not a draft: the exam opens to students before any question is added.",
  "exams.publishEmptyTitle": "Publish without questions?",
  "exams.publishEmptyWarning": "This exam has no questions. If you publish it, students will see an empty exam.",
  "exams.publishAnyway": "Publish anyway",
  "exams.savedAsDraftHint": "The exam is saved as a draft; publish it from the list when it is ready.",
  "events.status.present": "Attended",
  "events.status.absent": "Did not attend",
  "events.status.late": "Arrived late",
  "events.status.excused": "Excused",
  "events.rollCall.notStarted": "Roll call opens when the event starts.",
  "events.rollCall.opensAt": "Roll call opens when the event starts ({date}). Recorded statuses are shown below.",
  "events.rollCall.emptyRoster": "Nobody is in this event's audience.",
  "events.rollCall.searchHint": "Searches name, username or student number.",
  "events.rollCall.markRestPresent": "Mark the rest Attended",
  "events.rollCall.unsaved": "{status} · not saved",
  "events.rollCall.saveFailed": "{failed} of {total} rows could not be saved. The errors are shown on those rows.",
  "events.rollCall.saved": "{count} attendance marks saved.",
  "events.rollCall.pendingChanges": "{count} unsaved changes",
  "events.rollCall.noChanges": "No unsaved changes",
  "events.rollCall.discard": "Discard changes",
  ...
  "events.studentAttendanceHelp": "Everyone in the event's audience is listed. Pick a status on each row, then save them all at once.",
  ...
  "calendar.weekScrollHint": "Swipe sideways to see the other days.",
  ...
  "appointments.series.weekly": "Weekly",
  "appointments.series.once": "One-off",
  "appointments.time": "Time",
  "appointments.proposalPending": "New time proposed",
  "appointments.proposal": "Time proposal",
  ...
  "exams.draft": "Draft",
  "exams.emptyUpcoming": "No upcoming exams.",
  "exams.emptyCompleted": "No finished exams.",
  "exams.emptyDraft": "No draft exams.",
  ...
  "guide.step.ai.title": "Study with AI",
  "guide.step.ai.description": "Open your study chats in the AI Study area and work through course topics. For a quick question, use the Çelebi panel in the top bar.",
  "guide.step.ai.cta": "Open AI Study",
  "guide.step.ai.f1": "Find your study chats in one place",
  "guide.step.ai.f2": "Ask about course topics",
  "guide.step.ai.f3": "Open Çelebi from the top bar",
  "guide.step.notes.badge": "Notes and drawing",
  "guide.step.notes.title": "Smart notebook and drawing canvas",
  "guide.step.notes.description": "Create a private note on the Notes page, import a PDF or TXT file, and make freehand drawings on the canvas.",
  ...
  "guide.step.notes.f3": "Rich-text editor and OCR warning",
  ...
  "guide.step.exams.cta": "View exams",
  ...
  "guide.tips.import.body": "Use Import on the Notes page to create a note from a PDF or TXT file. Review the text before saving.",
  ...
  "courses.sectionsFilter": "Section",
  "courses.withSections": "Has sections",
  "courses.withoutSections": "No sections",
  ...
  "homework.wholeCourseHelp": "The homework is assigned to every student enrolled in this course.",
  ...
  "marks.band": "Grade band",
  "marks.bandLabel": "Band {grade}",
  "marks.examCount": "Exams",
  ...
  "profile.studentInfoEmpty": "No further details to show",
  "profile.studentInfoEmptyHint": "The school may not have filled these in yet.",
  "profile.gender": "Gender",
  "profile.genderNone": "Not set",
  "profile.genderFemale": "Female",
  "profile.genderMale": "Male",
  "profile.genderOther": "Other",
  "profile.genderUndisclosed": "Prefer not to say",
  ...
  "settings.subtitle": "Manage assessment, meal, and system policies for the school.",
  ...
  "meals.subtitle": "This week's menus. Pick a meal to book or record service.",
  ...
  "meals.empty": "No menus from this date on.",
  "meals.dishes": "dishes",
  ...
  "meals.prevWeek": "Previous week",
  "meals.nextWeek": "Next week",
  "meals.goToDate": "Go to date",
  "meals.today": "Today",
  "meals.weekDays": "Days of the week",
  "meals.menuCount": "{count} menus",
  "meals.emptyDay": "No menu published for this day.",
  "meals.emptyDayHint": "Choose another day or change the meal filter.",
  "meals.emptyWeek": "No menus published for this week.",
  "meals.emptyWeekHint": "Switch to another week or clear the meal filter.",
  "meals.unlimited": "Unlimited",
  "meals.dishCount": "{count} dishes",
  "meals.reservedOf": "{count} / {capacity}",
  "meals.studentRecordHelp": "Pick a student to manage their dietary profile and meal account.",
  "meals.selectStudentFirst": "Pick a student to see their record.",
  "meals.serviceHelp": "Booked students and recorded service.",
  "meals.addWalkIn": "Add walk-in",
  "meals.walkInHelp": "Record a student who came without a booking as served.",
  "meals.noService": "No bookings or service records yet.",
  "meals.serviceStatus": "Service",
  "meals.mark": "Mark",
  "meals.bookingState.booked": "Booked",
  "meals.bookingState.cancelled": "Cancelled",
  "meals.kind": "Type",
  "meals.detail": "Details",
  "meals.when": "Date",
  "meals.amount": "Amount",
  "meals.status": "Status",
  "meals.noAttendance": "No meal attendance yet.",
  ...
  "whiteboard.closeConfirm": "Close this board? It becomes read-only for good and cannot be reopened — lock it for a short pause instead.",
  ...
  "payments.searchStudents": "Search students…",
  ...
  "search.hint.courses": "Matches course title and description.",
  "search.hint.courseNotes": "Matches note title and content.",
  "search.hint.classes": "Matches class name, grade and homeroom teacher.",
  "search.hint.classMembers": "Matches student name, username and student number.",
  ...
  "search.hint.deadlines": "Matches the title and the course — class of the upcoming items.",
  ...
  "common.yes": "Yes",
  "common.no": "No",
  "settings.leaveHint": "Your unsaved changes to the settings will be lost.",
  "exams.kind.yazili": "Written",
  "exams.kind.uygulama": "Practical",
  "exams.kind.performans": "Performance",
  "meals.slotName.breakfast": "Breakfast",
  "meals.slotName.lunch": "Lunch",
  "meals.slotName.dinner": "Dinner",
  "meals.slotName.snack": "Snack",
  "meals.tagName.vegetarian": "Vegetarian",
  "meals.tagName.vegan": "Vegan",
  "meals.tagName.gluten_free": "Gluten-free",
  "meals.tagName.lactose_free": "Lactose-free",
  "meals.tagName.nut_allergy": "Nut allergy",
  "exams.createSubtitle": "Set the course, term and timing first; you add the questions in the next step.",
  "homework.gradeStatusPlaceholder": "Choose a status",
  "homework.gradeStatusRequired": "Choose a status before saving.",
  "combobox.showSuggestions": "Show suggestions",
  "combobox.suggestions": "Suggestions",
  "combobox.optionSelected": "{option}, selected",
  "combobox.optionCount": "Options available: {count}",
  "course.removeStudentTitle": "Remove the student from this course?",
  "course.removeStudentHint": "Their enrollment in this class's course is removed; the account itself is not deleted.",
  "course.removeStudentAction": "Remove from course",
  "admin.demoteAdminWarning": "This user will lose their system administrator rights.",
  "instances.policySaved": "Saved",
  "instances.dersSaatiInvalid": "Lesson hours must be a whole number, 0 or more.",
  "instances.karneConfirmTitle": "Change the report card setting?",
  "instances.karneOnHint": "This class's marks in the course will count toward the report card.",
  "instances.karneOffHint": "This class's marks in the course will no longer count toward the report card.",
  "instances.karneTurnOn": "Count toward report card",
  "instances.karneTurnOff": "Stop counting",
  "messages.discardDraftTitle": "Discard this draft?",
  "messages.discardDraftHint": "What you wrote in this message has not been sent and will be lost.",
  "messages.folders": "Folders",
  "messages.subject": "Subject",
  "messages.subjectPlaceholder": "What the message is about",
  "messages.label": "Label",
  "messages.sendHintRecipient": "Choose a recipient to send.",
  "messages.sendHintSubject": "Add a subject to send.",
  "errors.studentOnlyTitle": "This page is for students",
  "errors.parentOnlyTitle": "This page is for parents",
  "errors.audienceOnlyDescription": "This view is shown only to the student or parent signed in to their own account; staff accounts do not open it.",
  "errors.audienceOnlyWithAlternative": "This view is shown only to the student or parent signed in to their own account. The school-wide view of the same data is under management.",
  "errors.openStaffView": "Open the management view",
  "grade.kindergarten": "Kindergarten",
  "grade.level": "Grade {level}",
  "grade.select": "Select a grade",
  "instances.teachers": "Teachers",
  "instances.sectionsTruncated": "Showing {shown} of {total} sections; the full list is on the Classes page.",
  "override.inherited": "Inherited",
  "override.own": "Section's own",
  "override.reset": "Reset to template",
  "override.resetConfirmTitle": "Reset to the template?",
  "override.resetConfirmHint": "The section's own value is removed; from now on it follows the grade template.",
  "instances.settingsTab": "Section settings",
  "instances.settingsHelp": "This section inherits from the course's grade template. Changes here affect this section only.",
  "instances.contentTitle": "Title and description",
  "instances.contentHelp": "The course name this section shows. Fields left alone come from the template.",
  "instances.editContent": "Edit title and description",
  "instances.policyTitle": "Weekly hours and report card",
  "instances.subjectsTitle": "Topics",
  "instances.subjectsHelp": "The topics this section teaches. Exam questions and homework can only pick from these.",
  "instances.subjectsInheritedHint": "The template's topics apply. Adding or removing one starts a set of the section's own.",
  "instances.subjectsOwnHint": "The section uses its own set of topics.",
  "instances.addSubject": "Add topic",
  "instances.noSubjects": "No topics selected.",
  "instances.allSubjectsSelected": "Every topic of the course is already selected.",
  "instances.removeSubject": "Remove topic",
  "instances.examWeightsTitle": "Exam weights",
  "instances.examWeightsHelp": "How much each exam kind weighs in the report-card average (1–100).",
  "instances.examWeightsInheritedHint": "The template's weights apply. Changing one starts a table of the section's own.",
  "instances.examWeightsOwnHint": "The section uses its own weights; kinds without a row weigh 1.",
  "instances.weight": "Weight",
  "instances.setWeight": "Change weight",
  "instances.removeWeight": "Remove row",
  "instances.weightInvalid": "The weight must be a whole number from 1 to 100.",
  "instances.examKind": "Exam kind",
  "instances.addWeight": "Add weight",
  "weeklyPlan.tab": "Weekly plan",
  "weeklyPlan.title": "Weekly timetable",
  "weeklyPlan.help": "The lesson times that repeat every week.",
  "weeklyPlan.empty": "No lesson times yet.",
  "weeklyPlan.addSlot": "Add lesson time",
  "weeklyPlan.weekday": "Day",
  "weeklyPlan.time": "Time",
  "weeklyPlan.starts": "Starts",
  "weeklyPlan.ends": "Ends",
  "weeklyPlan.topic": "Topic",
  "weeklyPlan.topicHint": "Optional. Left empty, generated lessons carry the course title.",
  "weeklyPlan.timeInvalid": "Enter times as HH:mm; the end must be after the start.",
  "weeklyPlan.removeSlot": "Remove lesson time",
  "weeklyPlan.ownHint": "This section uses its own weekly plan.",
  "weeklyPlan.inheritedHint": "The grade template's week applies. Adding or removing a time starts a plan of the section's own.",
  "weeklyPlan.generate": "Generate lessons",
  "weeklyPlan.generateHelp": "Turns the weekly plan into dated lessons over the chosen dates. Holidays and already scheduled times are skipped; no lesson is ever deleted.",
  "weeklyPlan.from": "First day",
  "weeklyPlan.to": "Last day",
  "weeklyPlan.preview": "Preview",
  "weeklyPlan.apply": "Create {count} lessons",
  "weeklyPlan.previewSummary": "{candidates} lessons to create · {existing} already scheduled · {holiday} fall on a holiday",
  "weeklyPlan.appliedSummary": "{count} lessons created.",
  "weeklyPlan.blockedDays": "Days skipped for a holiday",
  "weeklyPlan.rangeInvalid": "Pick a valid date range; the last day cannot come before the first.",
  "weeklyPlan.rangeTooLong": "At most {days} days can be generated at once.",
  "weeklyPlan.nothingToCreate": "There are no new lessons to create in this range.",
  "weeklyPlan.noTeacherHint": "A teacher must be assigned to the section to generate lessons.",
  "offerings.tab": "Grade templates",
  "offerings.help": "This course's defaults per grade. Sections at that grade follow them unless they set their own.",
  "offerings.new": "New template",
  "offerings.empty": "No grade templates yet. Attaching the course to a class creates an empty one for its grade.",
  "offerings.edit": "Edit template",
  "offerings.delete": "Delete template",
  "offerings.deleteConfirm": "Delete the {grade} template? It cannot be deleted while a class at that grade teaches the course.",
  "offerings.titlePlaceholder": "Empty uses the course name: {title}",
  "offerings.descriptionPlaceholder": "Empty uses the course description.",
  "offerings.defaultDersSaati": "Default weekly hours",
  "offerings.defaultDersSaatiHint": "Empty means 1 hour.",
  "offerings.defaultKarne": "Counts toward report card",
  "offerings.inheritDefault": "Default (counted)",
  "offerings.detailsTitle": "Template details",
  "offerings.subjectsHelp": "The topics every section at this grade teaches.",
  "offerings.weightsHelp": "Each exam kind's report-card weight at this grade. Kinds without a row use the school setting.",
  "offerings.weeklyPlanHelp": "The default weekly lesson times of every section at this grade.",
  "offerings.hours": "{count} h",
  "nav.holidays": "Holiday calendar",
  "holidays.title": "Holiday calendar",
  "holidays.subtitle": "The school's non-teaching days. Generating lessons from a weekly plan skips them.",
  "holidays.new": "New holiday",
  "holidays.edit": "Edit holiday",
  "holidays.delete": "Delete holiday",
  "holidays.name": "Name",
  "holidays.kind": "Kind",
  "holidays.kind.resmi": "Public holiday",
  "holidays.kind.dini": "Religious holiday",
  "holidays.kind.idari": "Administrative leave",
  "holidays.kind.ara": "School break",
  "holidays.firstDay": "First day",
  "holidays.lastDay": "Last day",
  "holidays.range": "Dates",
  "holidays.days": "{count} days",
  "holidays.empty": "No holidays yet.",
  "holidays.deleteConfirm": "Delete \"{name}\"? Lessons already generated on those days stay.",
  "holidays.rangeInvalid": "Pick a valid date range; the last day cannot come before the first.",
  "search.hint.holidays": "Matches the holiday name and kind.",
  "holidays.dayCount": "Days",
};
