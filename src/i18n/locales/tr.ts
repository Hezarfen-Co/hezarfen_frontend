...
export const tr: Dict = {
  ...
  "common.showingOf": "{total} kayıttan {shown} tanesi gösteriliyor — kaydırdıkça devamı gelir",
  "common.rowCount": "Toplam: {total}",
  "common.loadingMore": "Devamı yükleniyor…",
  "common.loadMore": "Devamını yükle",
  ...
  "sidePanel.expand": "Paneli genişlet",
  "sidePanel.collapse": "Paneli daralt",
  "sidePanel.resize": "Panel genişliğini ayarla",
  ...
  "dashboard.col.section": "Ders / Şube",
  ...
  "whiteboard.canvasHintPickPen": "Çizmek için yukarıdan bir araç seç — tahtadaki herkes anlık görür.",
  "draw.tools": "Araçlar",
  "draw.rectangle": "Dikdörtgen",
  "draw.diamond": "Elmas",
  "draw.ellipse": "Elips",
  "draw.arrow": "Ok",
  "draw.line": "Çizgi",
  "draw.colorName.orange": "Turuncu",
  "draw.style": "Stil",
  "draw.widthThin": "İnce",
  "draw.widthBold": "Kalın",
  "draw.widthExtraBold": "Çok kalın",
  "draw.strokeStyle": "Çizgi stili",
  "draw.styleSolid": "Düz",
  "draw.styleDashed": "Kesikli",
  "draw.styleDotted": "Noktalı",
  "draw.sloppiness": "Özensizlik",
  "draw.slopArchitect": "Mimar",
  "draw.slopArtist": "Sanatçı",
  "draw.slopCartoonist": "Karikatürist",
  "draw.showGrid": "Izgarayı göster",
  "whiteboard.panHint": "Tuvali kaydırmak için tekerleği kullan ya da Boşluk tuşuna basılı tutup sürükle; yakınlaştırmak için Ctrl + tekerlek.",
  "whiteboard.shapeHint": "Kare, daire ya da 45° çizgi için Shift'e basılı tut.",
  "whiteboard.eraserHint": "Silmek istediğin çizgilerin üzerinden geç; bırakınca silinir.",
  "whiteboard.menu": "Tahta menüsü",
  "whiteboard.lockedBanner": "Tahta kilitli — çizim duraklatıldı.",
  "whiteboard.closedBanner": "Tahta kapatıldı: kalıcı olarak salt okunur, yeniden açılamaz.",
  "whiteboard.readOnlyBanner": "Bu tahtada katılımcı değilsin; yalnızca izleyebilirsin.",
  "whiteboard.you": "Sen",
  ...
  "calendar.weekScrollHint": "Diğer günleri görmek için yatay kaydırın.",
  "calendar.month": "Ay",
  "calendar.year": "Yıl",
  ...
  "appointments.startTime": "Başlangıç saati",
  "appointments.endTime": "Bitiş saati",
  ...
  "appointments.proposalPending": "Yeni saat önerildi",
  "appointments.proposal": "Saat önerisi",
  ...
  "guide.step.ai.title": "Yapay zekâ ile çalışma",
  "guide.step.ai.description": "Yapay Zekâ Çalışma alanında sohbetlerini açabilir ve ders konularını çalışabilirsin. Kısa sorular için üst çubuktaki Çelebi panelini kullan.",
  "guide.step.ai.cta": "Çalışma alanını aç",
  "guide.step.ai.f1": "Çalışma sohbetlerini tek yerde gör",
  "guide.step.ai.f2": "Ders konuları hakkında soru sor",
  "guide.step.ai.f3": "Çelebi paneline üst çubuktan eriş",
  "guide.step.notes.badge": "Notlar ve çizim",
  "guide.step.notes.title": "Akıllı defter ve çizim tuvali",
  "guide.step.notes.description": "Notlar sayfasından yeni bir özel not aç, PDF veya TXT dosyası içe aktar ve çizim tuvalinde serbest çizimler oluştur.",
  ...
  "guide.step.notes.f3": "Zengin metin düzenleyici ve OCR uyarısı",
  ...
  "guide.step.exams.cta": "Sınavları gör",
  ...
  "guide.tips.import.body": "Notlar sayfasındaki içe aktar butonuyla PDF ve TXT dosyalarından yeni bir not oluşturabilirsiniz. Metni kaydetmeden önce gözden geçirin.",
  ...
  "settings.subtitle": "Değerlendirme, yemekhane ve sistem kurallarını buradan yönetin.",
  ...
  "meals.subtitle": "Haftanın menüleri. Rezervasyon ve servis için bir öğün seçin.",
  ...
  "meals.thisWeek": "Bu hafta",
  "meals.prevWeek": "Önceki hafta",
  "meals.nextWeek": "Sonraki hafta",
  "meals.goToDate": "Tarihe git",
  "meals.today": "Bugün",
  "meals.weekDays": "Haftanın günleri",
  "meals.menuCount": "{count} menü",
  "meals.emptyDay": "Bu gün için menü yayınlanmamış.",
  "meals.emptyDayHint": "Başka bir gün seçin veya öğün filtresini değiştirin.",
  "meals.emptyWeek": "Bu hafta için yayınlanmış menü yok.",
  "meals.emptyWeekHint": "Başka bir haftaya geçin veya öğün filtresini kaldırın.",
  "meals.unlimited": "Sınırsız",
  "meals.dishCount": "{count} yemek",
  "meals.reservedOf": "{count} / {capacity}",
  "meals.studentRecordHelp": "Öğrenci seçin; beslenme profilini ve yemek hesabını yönetin.",
  "meals.selectStudentFirst": "Kaydı görmek için bir öğrenci seçin.",
  "meals.serviceHelp": "Rezervasyonlu öğrenciler ve kaydedilen servis.",
  "meals.addWalkIn": "Rezervasyonsuz ekle",
  "meals.walkInHelp": "Rezervasyonu olmadan gelen öğrenciyi servis edildi olarak kaydedin.",
  "meals.noService": "Henüz rezervasyon veya servis kaydı yok.",
  "meals.serviceStatus": "Servis",
  "meals.mark": "İşaretle",
  "meals.bookingState.booked": "Rezerve",
  "meals.bookingState.cancelled": "İptal edildi",
  "meals.kind": "Tür",
  "meals.detail": "Açıklama",
  "meals.when": "Tarih",
  "meals.amount": "Tutar",
  "meals.status": "Durum",
  "meals.noAttendance": "Yemek katılımı kaydı yok.",
  ...
  "whiteboard.closeConfirm": "Bu tahta kapatılsın mı? Kalıcı olarak salt okunur olur ve yeniden açılamaz; kısa bir ara için kilitlemeyi kullan.",
  ...
  "search.hint.courses": "Ders ad\u0131 ve a\u00e7\u0131klamas\u0131nda arar.",
