...
export const tr: Dict = {
  ...
  "aiStudio.run.title": "Üretim ayrıntısı",
  "aiStudio.run.source": "Kaynak not",
  "aiStudio.run.started": "Başladı",
  "aiStudio.run.ended": "Bitti",
  "aiStudio.run.length": "Uzunluk",
  ...
  "podcast.transcript.follow": "Oynatılan yere dön",
  "podcast.transcript.seek": "{time} konumundan dinle",
