...
export type MessageKey =
  ...
  | "errors.pageLoad.title"
  | "errors.pageLoad.retry"
  | "errors.pageLoad.retryIn"
  | "errors.pageLoad.details"
  | "errors.pageLoad.status"
  | "errors.pageLoad.kind"
  | "errors.pageLoad.code"
  | "errors.pageLoad.module"
  | "errors.pageLoad.retryAfter"
  | "errors.pageLoad.seconds"
  | "errors.pageLoad.page"
  | "errors.pageLoad.message"
  | "errors.pageLoad.kind.rateLimited"
  | "errors.pageLoad.kind.moduleOff"
  | "errors.pageLoad.kind.unauthorized"
  | "errors.pageLoad.kind.forbidden"
  | "errors.pageLoad.kind.timeout"
  | "errors.pageLoad.kind.unavailable"
  | "errors.pageLoad.kind.server"
  | "errors.pageLoad.kind.request"
  | "errors.pageLoad.kind.offline"
  | "errors.pageLoad.kind.network"
  | "errors.pageLoad.kind.render"
  | "errors.recordNotFound.title"
  | "errors.recordNotFound.description"
  | "errors.recordNotFound.backToList"
  | "errors.recordNotFound.backHome"
  ...
  | "draw.showGrid"
  | "whiteboard.panHint"
  | "whiteboard.shapeHint"
  | "whiteboard.eraserHint"
  | "whiteboard.menu"
  | "whiteboard.lockedBanner"
  | "whiteboard.closedBanner"
  | "whiteboard.readOnlyBanner"
  | "whiteboard.you"
  ...
  | "meals.dishCount"
  | "meals.reservedOf"
  | "meals.studentRecordHelp"
  | "meals.selectStudentFirst"
  | "meals.serviceHelp"
  | "meals.addWalkIn"
  | "meals.walkInHelp"
  | "meals.noService"
  | "meals.serviceStatus"
  | "meals.mark"
  | "meals.bookingState.booked"
  | "meals.bookingState.cancelled"
  | "meals.kind"
  | "meals.detail"
  | "meals.when"
  | "meals.amount"
  ...
  | "appointments.time"
  | "appointments.proposalPending"
  | "appointments.proposal"
  | "appointments.date"
  | "appointments.status"
